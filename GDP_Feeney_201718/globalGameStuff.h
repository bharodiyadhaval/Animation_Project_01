...
extern cSimpleAssimpSkinnedMesh* g_pRPGSkinnedMesh2;
extern int selectcharacter;
// For stencil buffer example...
extern cGameObject* g_Room;						// in theMain.cpp
extern cGameObject* g_RoomMaskForStencil;		// in theMain.cpp
extern float keytime;
extern bool keyflag;
extern bool charswitch;
extern bool boyW, boyA, boyD, alW, alA, alD, boyJ, alJ, boySW, alSW, boySS, alSS, boyS, alS, boyR, alR;
extern bool W, A, D, SBAR, J, SW, SS, S;
#endif
